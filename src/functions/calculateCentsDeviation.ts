 ...
 * 
 * @example
 * // Calculate deviation for a quarter-tone sharp note
 * const deviation = calculateCentsDeviation(60.5, "50", 60, "C+", "C");
 * // Returns 50 cents deviation
 * 
 * @example
 * // Handle enharmonic spelling
 * const deviation1 = calculateCentsDeviation(63, "0", 60, "D#", "C");
 * const deviation2 = calculateCentsDeviation(63, "0", 60, "Eb", "C");
 * // Different results based on sharp vs flat spelling
 */
 ...
 * 
 * @example
 * parseEnglishNoteName("Db+") 
 * // Returns: { baseNote: "D", chromaticSemitones: 2, mainAccidental: "b" }
 */
 ...
 * 
 * @example
 * const result = calculateCentsDeviationWithReferenceNote(63.5, "50", 60, "Eb+", "C");
 * // Returns: { deviation: 50, referenceNoteName: "Eb" }
 */
 ...
 * 
 * @example
 * getNoteName("E", 1) // Returns "F" (E# = F)
 * getNoteName("C", -1) // Returns "B" (Cb = B)
 * getNoteName("D", 1) // Returns "D#"
 */
