 ...
 * 
 * @example
 * getFirstNoteName([0, 2, 4]) // Returns the note name at index 0 (typically "D3Js")
 * 
 * @example
 * getFirstNoteName([]) // Returns "none"
 * 
 * @example
 * getFirstNoteName([-1, 5]) // Returns "none" (first index is invalid)
 */
