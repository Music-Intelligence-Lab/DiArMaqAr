...
const translations = {
  en: {
    ...
    "settings.tempoDown": "Decrease tempo",
    "settings.tempoUp": "Increase tempo",
    "settings.patternSelect": "Pattern Select",
    "settings.drone": "Drone",
    "settings.input": "Input",
    "settings.output": "Output",
    "settings.internalSynth": "Internal synth",
    "settings.previousWaveform": "Previous sound",
    "settings.nextWaveform": "Next sound",
    "settings.waveformOverridden": "MIDI output is driving the sound.",
    ...
    "settings.octaveDown": "Octave down",
    "settings.octaveUp": "Octave up",
    ...
    // Screen-reader name for the ghammāz mark, which is drawn, not written
    "maqam.ghammaz": "ghammāz",
    "maqam.noteNames": "Note Name",
    ...
    "tuningSystem.startingNoteName": "Starting Note Name and Reference Frequency:",
    "tuningSystem.tooltip.disabledForJins": "The selected jins is not available in this tuning system with this starting note name",
    "tuningSystem.tooltip.disabledForMaqam": "The selected maqām is not available in this tuning system with this starting note name",
    "tuningSystem.tooltip.itemDisabledForJins": "The selected jins is not available in this tuning system",
    "tuningSystem.tooltip.itemDisabledForMaqam": "The selected maqām is not available in this tuning system",
    "jins.tooltip.itemNotAvailable": "This jins is not available in this tuning system with the selected starting note name",
    "maqam.tooltip.itemNotAvailable": "This maqām is not available in this tuning system with the selected starting note name",
    ...
    "tuningSystem.exportTuningSystem": "Export Tuning System",
    ...
    // The contour states pitch height and melodic direction in geometry
    // alone. These four build the screen-reader sentence that carries the
    // same facts in text — "begin on ʿajam", "ascend to awj".
    "sayr.ascendTo": "ascend to",
    "sayr.descendTo": "descend to",
    "sayr.beginOn": "begin on",
    "sayr.remainOn": "remain on",
    "sayr.delete": "Delete",
  ...
  ar: {
    ...
    "settings.tempoDown": "خفض السرعة",
    "settings.tempoUp": "رفع السرعة",
    "settings.patternSelect": "اختيار النمط",
    "settings.drone": "الدرون",
    "settings.input": "الإدخال",
    "settings.output": "الإخراج",
    "settings.internalSynth": "المولّد الداخلي",
    "settings.previousWaveform": "الصوت السابق",
    "settings.nextWaveform": "الصوت التالي",
    "settings.waveformOverridden": "مخرج الميدي يقود الصوت.",
    ...
    "settings.attack": "البداية",
    "settings.decay": "الهبوط",
    "settings.sustain": "الثبات",
    "settings.release": "النهاية",
    ...
    "settings.octaveDown": "خفض أوكتاف",
    "settings.octaveUp": "رفع أوكتاف",
    ...
    "maqam.selectLoadToKeyboard": "اختر وحمّل",
    ...
    "tuningSystem.startingNoteName": "اسم اول نغمة في بنية التنغيم والتردد المرجعي:",
    "tuningSystem.tooltip.disabledForJins": "الجنس المحدد غير متوفر في نظام التنغيم هذا انطلاقاً من هذه النغمة",
    "tuningSystem.tooltip.disabledForMaqam": "المقام المحدد غير متوفر في نظام التنغيم هذا انطلاقاً من هذه النغمة",
    "tuningSystem.tooltip.itemDisabledForJins": "الجنس المحدد غير متوفر في نظام التنغيم هذا",
    "tuningSystem.tooltip.itemDisabledForMaqam": "المقام المحدد غير متوفر في نظام التنغيم هذا",
    "jins.tooltip.itemNotAvailable": "هذا الجنس غير متوفر في نظام التنغيم هذا انطلاقاً من النغمة المحددة",
    "maqam.tooltip.itemNotAvailable": "هذا المقام غير متوفر في نظام التنغيم هذا انطلاقاً من النغمة المحددة",
    ...
    "tuningSystem.exportTuningSystem": "تصدير بنية التنغيم",
    ...
    // Verbal nouns, matching the register the rest of the sayr strings use.
    "sayr.ascendTo": "صعود إلى",
    "sayr.descendTo": "هبوط إلى",
    "sayr.beginOn": "بدء من",
    "sayr.remainOn": "بقاء على",
    "sayr.delete": "حذف",
  ...
  fr: {
    ...
    "settings.tempo": "Tempo (BPM)",
    "settings.tempoDown": "Diminuer le tempo",
    "settings.tempoUp": "Augmenter le tempo",
    "settings.patternSelect": "Sélection du motif",
    "settings.drone": "Drone",
    "settings.input": "Entrée",
    "settings.output": "Sortie",
    "settings.internalSynth": "Synthé interne",
    "settings.previousWaveform": "Son précédent",
    "settings.nextWaveform": "Son suivant",
    "settings.waveformOverridden": "La sortie MIDI pilote le son.",
    ...
    "settings.attack": "Attaque",
    "settings.decay": "Déclin",
    "settings.sustain": "Maintien",
    "settings.release": "Relâchement",
    ...
    "settings.octaveDown": "Octave inférieur",
    "settings.octaveUp": "Octave supérieur",
    ...
    "jins.selectLoadToKeyboard": "Sélectionner & charger",
    ...
    "maqam.selectLoadToKeyboard": "Sélectionner & charger",
    "maqam.ascendingDescending": "Asc > Desc",
    ...
    "maqam.ghammaz": "ghammāz",
    "maqam.noteNames": "Nom de la note",
    ...
    "tuningSystem.startingNoteName": "Nom de la note de départ et fréquence de référence :",
    "tuningSystem.tooltip.disabledForJins": "Le jins sélectionné n'est pas disponible dans ce système d'accord avec cette note de départ",
    "tuningSystem.tooltip.disabledForMaqam": "Le maqām sélectionné n'est pas disponible dans ce système d'accord avec cette note de départ",
    "tuningSystem.tooltip.itemDisabledForJins": "Le jins sélectionné n'est pas disponible dans ce système d'accord",
    "tuningSystem.tooltip.itemDisabledForMaqam": "Le maqām sélectionné n'est pas disponible dans ce système d'accord",
    "jins.tooltip.itemNotAvailable": "Ce jins n'est pas disponible dans ce système d'accord avec la note de départ sélectionnée",
    "maqam.tooltip.itemNotAvailable": "Ce maqām n'est pas disponible dans ce système d'accord avec la note de départ sélectionnée",
    ...
    "tuningSystem.exportTuningSystem": "Exporter le système d'accord",
    ...
    "sayr.beginOn": "commencer sur",
    "sayr.remainOn": "rester sur",
