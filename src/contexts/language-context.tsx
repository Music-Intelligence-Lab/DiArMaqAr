...
const translations = {
  en: {
    ...
    'jins.cents': 'cents (¢)',
    'jins.centsFromZero': 'cents from zero (¢)',
    'jins.centsDeviation': 'deviation (¢)',
    ...
    'filter.cents': 'Cents',
    'filter.centsFromZero': 'Cents from Zero',
    ...
    'maqam.cents': 'Cents',
    'maqam.centsFromZero': 'Cents from Zero (¢)',
    'maqam.centsDeviation': 'Deviation (¢)',
    ...
    'octave.cents': 'Cents (¢)',
    'octave.centsDeviation': 'Deviation (¢)',
    ...
    'analysis.centsFromZero': 'cents from zero (¢)',
    'analysis.centsDeviation': 'deviation (¢)',
  ...
  ar: {
    ...
    'octave.cents': 'سنت (¢)',
    'octave.centsDeviation': 'الانحراف (¢)',
    ...
    'analysis.centsDeviation': 'الانحراف (¢)',
