...
export default function Navbar() {
  ...
  const { selectedTuningSystem, selectedJins, selectedMaqam, ajnas, checkIfJinsIsSelectable, maqamat, checkIfMaqamIsSelectable, maqamSayrId, sources, selectedCells, selectedIndices, setSelectedTuningSystem, clearSelections, setPitchClasses, setSelectedIndices, setNoteNames} = useAppContext();
