...
exports.frequencyToMidiNoteNumber = frequencyToMidiNoteNumber;
exports.default = convertPitchClass;
exports.shiftPitchClassBaseValue = shiftPitchClassBaseValue;
...
function decimalToFraction(decimal) {
    ...
    const gcdValue = (0, gcd_1.default)(bestNumerator, bestDenominator);
...
function convertPitchClass(originalValue, inputType, stringLength, referenceFrequency) {
...
function shiftPitchClassBaseValue(baseValue, inputType, targetOctave) {
    if (targetOctave === 1)
        return baseValue;
    ...
    try {
        if (inputType === "fraction") {
            ...
            const g = (0, gcd_1.default)(newNum, newDen);
...
//# sourceMappingURL=convertPitchClass.js.map