...
export function exportToScalaKeymap(tuningSystem: TuningSystem, startingNote: NoteName, referenceNote: NoteName = startingNote, referenceFrequency?: number, mapSize?: number): string {
  ...
  const referenceNoteIndex = uniquePitchClasses.findIndex((pc) => pc.noteName === referenceNote);
 ...
 */
export function exportJinsToScala(jinsInput: Jins | JinsData, tuningSystem: TuningSystem, startingNote?: NoteName, description?: string): string {
  let jins: Jins;
 ...
 */
export function exportMaqamToScala(maqamInput: Maqam | MaqamData, tuningSystem: TuningSystem, startingNote?: NoteName, useAscending: boolean = true, description?: string): string {
  let maqam: Maqam;
