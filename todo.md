...
# 15 May 2025
- Selecting new tuning system starting note name, should not deselect the currently selcted maqam or jins IF they are possible in that selected tuning system
- Al-Urmawi First Oud Tuning and Al-Farabi 22 Tone - wrong note name configuration
