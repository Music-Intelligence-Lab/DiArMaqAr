...
## Section A: Simple .scl Export (Tuning System)

### When to Use

Export a tuning system's pitch classes as-is, without keyboard mapping or maqām-specific modifications.
...
! - maqām bayyāt shūrī (and its octave equivalents: ...)
