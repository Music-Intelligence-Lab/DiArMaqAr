---
url: /docs/guide/transposition.md
...
```bash
# Get maqām with all transpositions
curl "http://localhost:3000/api/maqamat/maqam_rast?tuningSystem=IbnSina-(1037)&startingNote=ushayran&includeTranspositions=true"
...
* Learn about [Modulation](/guide/modulation/) (related but distinct)
